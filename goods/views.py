...
def catalog(request):
    context = {
        'title': 'TopCaseOm - Каталог',
        'goods':[
            {'image': 'deps/images/goods/UAG_HS_APPLE_IPHONE-2023-KRYPTO_METRO-LT_KEVLAR-OLIVE_STD_01_MAGSAFE_ICON/1.jpg',
             'name': 'Чехол Uag Metropolis LT ткань Armortex для iPhone 13 6.1" оливковый (Kevlar-Olive)',
             'description': 'Чехол Uag Metropolis LT ткань Armortex для iPhone 13 6.1" оливковый (Kevlar-Olive).',
             'price': 65.00},
